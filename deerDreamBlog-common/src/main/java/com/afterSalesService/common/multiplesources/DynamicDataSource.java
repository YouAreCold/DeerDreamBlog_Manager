package com.afterSalesService.common.multiplesources;
...
public class DynamicDataSource extends AbstractRoutingDataSource {
	...
	private static final String DEFAULT = "dataSource_afterSalesService";
	private static final String SLAVE = "dataSource_myuser";
	...
	public void afterPropertiesSet() {
		if (null == master) {
			throw new IllegalArgumentException("Property 'afterSalesService' is required");
		}
