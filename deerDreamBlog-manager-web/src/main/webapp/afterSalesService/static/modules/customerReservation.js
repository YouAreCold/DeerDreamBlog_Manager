...
layui.define(["table", "form", "element"], function(e) {
	...
	i.render({
		...
		url:"http://127.0.0.1:8081/reservation/read/listPage",
		method:"POST",
		toolbar: true,
		cols: [
			[{
				...
				field: "fOrderItemnumber",
				title: "产品代码",
				align: "center",
				width: 100
			}, {
				field: "fOrderItemnote",
				title: "产品品牌",
				align: "center",
				width: 200
			}, {
				field: "fOrderItemname",
				title: "产品名称",
				align: "center",
				width: 120
			}, {
				field: "fOrderItemcolor",
				title: "产品颜色",
				align: "center",
				width: 70
			}, {
		...
		var i = t.data;
		if("del" === t.event) layer.confirm("确定删除此预约数据？", function(e) {
			var jsonData = { "id" : i.id };
			 $.ajax({
                url: "http://127.0.0.1:8081/reservation/read/delete?dels=-1",
                type: "POST",
