...
public class UUserRoleController extends AbstractController<BaseFacadeImpl> {
    @Reference
	private IUUserRoleService uUserRoleService;
	
	public IUUserRoleService getService() {
		return uUserRoleService;
	}
	
	@ApiOperation(value = "分页条件查询")
	@PutMapping(value = "/read/listPage")
	public Object queryPage(ModelMap modelMap, @RequestBody Map<String, Object> param) {
	    param.put("class", UUserRole.class);
	...
	public Object get(ModelMap modelMap, @RequestBody UUserRole param) {
	...
	public Object delete(ModelMap modelMap, @RequestBody UUserRole param,@RequestParam("dels") String dels) {
