package com.afterSalesService.common.constants;
...
public interface Constants {
	 ...
	 * 非常遗憾的通知您,程序发生了异常
	 */
	static final String Exception_Head = "SOME ERRORS OCCURED! AS FOLLOWS :";
	/** 缓存键值 */
	...
	/** 缓存命名空间 */
	static final String CACHE_NAMESPACE = "micro:";
	/** 在线用户数量 */
