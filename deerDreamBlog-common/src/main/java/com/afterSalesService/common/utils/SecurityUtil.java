...
import com.afterSalesService.common.security.BASE64Encoder;
import com.afterSalesService.common.security.coder.DESCoder;
import com.afterSalesService.common.security.coder.HmacCoder;
import com.afterSalesService.common.security.coder.MDCoder;
import com.afterSalesService.common.security.coder.RSACoder;
import com.afterSalesService.common.security.coder.SHACoder;
...
public final class SecurityUtil {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * System.out.println(encryptMd5("SHJR")); System.out.println(encryptSHA("1"));
		 * Map<String, Object> key = RSACoder.initKey(); String privateKey =
		 * encryptBASE64(RSACoder.getPrivateKey(key)); String publicKey =
		 * encryptBASE64(RSACoder.getPublicKey(key)); System.out.println(privateKey);
		 * System.out.println(publicKey); String sign = signRSA("132", privateKey);
		 * System.out.println(sign); String encrypt = encryptRSAPrivate("132",
		 * privateKey); System.out.println(encrypt); String org =
		 * decryptRSAPublic(encrypt, publicKey); System.out.println(org);
