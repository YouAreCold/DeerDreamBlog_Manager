package com.afterSalesService.pojo.organization.bo;
...
public class OrganizationBo extends BaseModel {
    ...
    /**
     * 当前状态  0 正常  1 预约  2  忽略  3 推迟
     */
    @ApiModelProperty(value = "当前状态  0 正常  1 预约  2  忽略  3 推迟")
	@TableField("f_status")
	private int fStatus;
     ...
     * 部门名称(外键)
     */
    @ApiModelProperty(value = "部门名称(外键)")
